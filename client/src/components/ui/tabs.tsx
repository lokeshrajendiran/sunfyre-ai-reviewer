...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-md transition-colors",
      ...
      "data-[state=active]:border-x data-[state=active]:border-t border-gray-200 dark:border-gray-800",
      className
    )}
    {...props}
  />
